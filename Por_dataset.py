...
def main():
    ...
    ax.set_title('Pareto Front of NSGA-II Optimization for Por Dataset')
    plt.tight_layout()
    plt.savefig('pareto_front_pymoo_nn_epoch_por.png')
    ...
    with open("results/metrics_por.txt", "w") as f:
    ...
    def analyze_explanations_by_group(model, X, sensitive):
        ...
        ax.legend()
        plt.tight_layout()
        plt.savefig('feature_importance_by_group_shap_lime_por.png')
    ...
    # Compute stability scores for each instance.
        ...
        plt.tight_layout()
        plt.savefig('stability_distribution_by_group_combined_por.png')
